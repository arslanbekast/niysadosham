...
<body>
    ...
    <div class="container">
        ...
        <div class="search-form">
            <div class="search-form__input-wrapper">
                <input type="text" id="word" placeholder="Дош йа терахь дӀайазде (дд.мм.гггг, 1 сентября)" class="search-form__input">
        ...
        <div class="about">
            ...
            <div class="about__instructions">
                ...
                <ol>
                    <li>Сизкепа чу <span class="instructions__img"><img src="img/snapshots/search-form.png" /></span> масех элпа йа цхьа дош йаздина 
                    <span class="instructions__img instructions__search-btn-img"><img src="img/snapshots/search-btn.png" /></span> тӀетаӀича, лахахь схьаго карийна дешнаш. 
                        Царах къел сиз хьаькчарна тӀетаӀича дешнийн кепаш схьаго.</li>
                    <li>Сизкепа чу терахь йа рузман терахь  йаздича, иза текстан кепехь дӀайаздо.</li>
                    <!-- <li>   
                ...
                <p class="about__instructions-title">«НийсаДошам» веназ смартфонан Google Chrome экран тӀе муха хӀоттайо?</p>
                <ol>
                    <li>Лакхара аьтту агӀорара кхо тӀадам тӀетаӀабо.</li>
                    <li>«Коьртачу экран тӀе йаккха» тӀетаӀадо.</li>
                    <li>«ТӀейаккха» тӀетаӀадо.</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div id="about-modal" class="modal">
        ...
        <div class="about__description">
            <p><span class="description__title">НийсаДошам</span> – нохчийн меттан нийсайаздаран онлайн дошам – вовшахтоьхна «Овхадов М.Р., Халидов А.И., Вагапов Ӏ.Д., Умхаев Хь.С., Ирезиев С.-Хь.С.-Э., Солтаханов И.Э., Абдулкадыров А.Т., Бадаева Ӏ.С., Юнусов Хь.И., Дадаев С.-Хь.П., Султанов З.А. Нохчийн меттан нийсайаздаран йокха дошам. Соьлжа-ГIала. 2023, 1024 агӀо» бух тӀаьхь.</p>
        </div>
        <h3>Программа кечйинарг: «Дош» ДЖЙ:</h3>
        <ul>
    ...
    <div id="help-modal" class="modal">
        <p>ХӀокху могӀанчу дош йа терахь йаздо:</p>
        <ul>
            <li>дд.мм.гггг</li>
            <li>дд/мм/гггг</li>
            <li>дд-мм-гггг</li>
